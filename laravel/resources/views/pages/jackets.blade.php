			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-4 box_col">
						<div class="box">
							<div class="box_title trans_200"><a href="{{ route('createjackets') }}">Add New Jacket</a></div>
						</div>
					</div>
				</div>
			</div>
									...
									<div class="product grid-item hot">
										<div class="product_inner">
											<div class="product_image">
												<img src="http://adam.mib-printsifu.ga/laravel/storage/app/public/image/{{$jacket->image}}" height="370" alt="">
											</div>
											<div class="product_content text-center">
												<div class="product_title"><a href="{{ route('showjackets', ['id' => $jacket->id]) }}">{{$jacket->name}}</a></div>
												<div class="product_title">{{$jacket->brand}}</div>
												<div class="product_price">RM{{$jacket->price}}</div>
												<div style="display:flex;">
													<div class="product_button ml-auto mr-auto trans_200"><a href="{{ route('deletejacket', ['id'=> $jacket->id]) }}">delete</a></div>
												</div>
											</div>
										</div>	
									</div>
