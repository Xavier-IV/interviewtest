	...
	<div class="home">
		...
		<div class="home_container">
			<div class="home_content">
				<div class="home_title">Create sneaker</div>
			</div>
		</div>
	</div>
						...
						<div class="checkout_container d-flex flex-xxl-row flex-column align-items-start justify-content-start">
							...
							<div class="billing checkout_box">
								<div class="checkout_form_container">
									<form action="{{ route('createsneakers') }}" method="POST" id="addform" class="checkout_form" enctype="multipart/form-data">
									@csrf
										<div>
									    ...
									    <div class="checkout_button trans_200"><a href="#" onclick="document.getElementById('addform').submit()">Add sneaker</a></div>
									</form>
								</div>
							</div>
						</div>
