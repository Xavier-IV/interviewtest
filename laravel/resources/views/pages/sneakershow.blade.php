...
<html lang="en">
<head>
<title>Sneaker information</title>
<meta charset="utf-8">
	...
	<div class="home">
		<div class="home_container">
			<div class="home_content">
				<div class="home_title">Sneaker information</div>
			</div>
		</div>
	</div>
								...
								<div  class="checkout_form">
									...
									<div class="row">
										<div class="col-lg-6">
											...
											<input type="text" id="name" name="name" class="checkout_input" value="{{$sneaker->name}}" disabled>
										</div>
										<div class="col-lg-6">
											<label for="checkout_last_name">Price</label>
											<input type="number" id="price" name="price" class="checkout_input" value="{{$sneaker->price}}" disabled>
										</div>
									</div>
									<div>
										<label for="checkout_company">Brand of sneaker</label>
										<input type="text" id="brand" name="brand" class="checkout_input" value="{{$sneaker->brand}}" disabled>
									</div>
									<div class="checkout_button trans_200"><a href="{{ route('editsneaker', ['id' => $sneaker->id]) }}">Edit sneaker</a></div>
								</div>
							</div>
						</div>
					</div>
