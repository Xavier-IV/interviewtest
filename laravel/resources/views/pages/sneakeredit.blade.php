	...
	<div class="home">
		...
		<div class="home_container">
			<div class="home_content">
				<div class="home_title">Edit sneaker</div>
			</div>
		</div>
	</div>
						...
						<div class="checkout_container d-flex flex-xxl-row flex-column align-items-start justify-content-start">
							...
							<div class="billing checkout_box">
								<div class="checkout_form_container">
									<form action="{{ route('editsneaker', ['id' => $sneaker->id]) }}" method="POST" id="editform" class="checkout_form" enctype="multipart/form-data">
									@csrf
										<div class="product_image">
											<img src="http://adam.mib-printsifu.ga/laravel/storage/app/public/image/{{$sneaker->image}}" alt="">
											<input type="file" name="image" id="image">
										</div>
										<div class="row">
											<div class="col-lg-6">
												<label for="checkout_name">Name of sneaker</label>
												<input type="text" id="name" name="name" class="checkout_input" value="{{$sneaker->name}}">
											</div>
											<div class="col-lg-6">
												<label for="checkout_last_name">Price</label>
												<input type="number" id="price" name="price" class="checkout_input" value="{{$sneaker->price}}">
											</div>
										</div>
										<div>
											<label for="checkout_company">Brand of sneaker</label>
											<input type="text" id="brand" name="brand" class="checkout_input" value="{{$sneaker->brand}}">
                                        </div>
									    <div class="checkout_button trans_200"><a href="#" onclick="document.getElementById('editform').submit()">Update sneaker</a></div>
									</form>
								</div>
							</div>
						</div>
