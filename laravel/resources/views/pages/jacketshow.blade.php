...
<html lang="en">
<head>
<title>Jacket information</title>
<meta charset="utf-8">
	...
	<div class="home">
		...
		<div class="home_container">
			<div class="home_content">
				<div class="home_title">Jacket information</div>
			</div>
		</div>
	</div>
							...
							<div class="billing checkout_box">
								<div class="checkout_form">
									<div class="product_image">
										<img src="http://adam.mib-printsifu.ga/laravel/storage/app/public/image/{{$jacket->image}}" alt="">
									</div>
									<div class="row">
										<div class="col-lg-6">
											<label for="checkout_name">Name of jacket</label>
											<input type="text" id="name" name="name" class="checkout_input" value="{{$jacket->name}}" disabled>
										</div>
										<div class="col-lg-6">
											<label for="checkout_last_name">Price</label>
											<input type="number" id="price" name="price" class="checkout_input" value="{{$jacket->price}}" disabled>
										</div>
									</div>
									<div>
									</div>
									<div>
										...
										<input type="text" id="brand" name="brand" class="checkout_input" value="{{$jacket->brand}}" disabled>
									</div>
									<div class="checkout_button trans_200"><a href="{{ route('editjacket', ['id' => $jacket->id]) }}">Edit jacket</a></div>
								</div>
							</div>
						</div>
					</div>
